...
// il contratto crea inoltre e dona un NFT ai donatori
contract Crowfunding is ERC721{
    /// EVENTS
    ...
    /// CONTRUCTOR
        // chiamo ance il constructor di ERC721
    ...
    /// METHODS
        ...
        function contribute(uint256 amount) public payable {
            ...
            // conio NFT che voglio donare e lo do al sender del contributo usando il metodo di ERC721 _mint
